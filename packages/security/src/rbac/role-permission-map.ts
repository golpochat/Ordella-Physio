...
export const PERMISSION_ROLE_MAP = {
  ...
  "ai.model.view": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
  "ai.model.manage": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
  "ai.dataset.view": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
  "ai.dataset.manage": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
  "ai.dataset.label": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
  "ai.training.view": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
  "ai.training.manage": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
  "ai.use": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN", "THERAPIST"],
  "ai.manage": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
  "ai.admin": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
  "ai.evaluation.run": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
  "ai.promotion.manage": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
  "ai.drift.view": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
  "ai.drift.mitigate": ["SUPER_ADMIN", "TENANT_OWNER", "OWNER", "ADMIN", "CLINIC_ADMIN"],
