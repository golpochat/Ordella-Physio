...
import { patientUpdateForbiddenError } from "@/utils/patient-errors";
...
@Injectable()
export class PatientUpdateManageGuard implements CanActivate {
  canActivate(context: ExecutionContext): boolean {
    ...
    if (!hasManagePermission) {
      throw patientUpdateForbiddenError();
    }
