...
It is responsible for handling all domain logic related to **invoicing, tax rates, and billing discounts**.
...
## Features
- Core domain logic for invoice generation and billing workflows
- Tax rate configuration and discount management
- Domain modules: `invoices`, `tax-rates`, `discounts`, `events`
...
```bash
# From repo root
pnpm --filter @ordella/billing-service dev

# Or from this directory
pnpm dev
```

Default URL: **http://localhost:3056**
...
├── src/
│   ├── invoices/     # Invoice CRUD and line items
│   ├── tax-rates/    # Regional tax configuration
│   ├── discounts/    # Promotional and manual discounts
...
- **Docker Compose:** `services/billing-service/docker-compose.yml`
- **Kubernetes:** `infrastructure/deployment-layer/k8s/base/billing-service-*.yaml`
- **Image:** `ghcr.io/ordella/billing-service`
...
**Package name:** `@ordella/billing-service`
