...
export function loadStorageConfig(): StorageConfig {
  ...
  return {
    ...
    signedUrlTtlSeconds: Number(process.env.FILE_STORAGE_SIGNED_URL_TTL_SECONDS ?? "60"),    maxFileBytes: Number(process.env.FILE_STORAGE_MAX_BYTES ?? String(50 * 1024 * 1024)),
  };
}
