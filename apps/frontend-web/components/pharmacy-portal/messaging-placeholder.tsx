...
const PLACEHOLDER_MESSAGES = [
  {
    id: "1",
    sender: "Clinic admin",
    content: "Please prioritize the prescription for patient in room 3.",
    time: "Today",
  },
  {
    id: "2",
    sender: "You",
    content: "Acknowledged — preparing the order now.",
    time: "Today",
  },
];

export function PharmacyMessagingPlaceholder() {
  return (
    <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
      <Card className="flex min-h-[420px] flex-col">
        <CardHeader>
          <CardTitle>Pharmacy messaging</CardTitle>
          <CardDescription>Placeholder inbox for clinic and therapist communication.</CardDescription>
        </CardHeader>
