...
import type { PharmacyPatient } from "@/lib/pharmacy-portal-types";
import { formatPortalDate, getPatientDisplayName } from "@/lib/pharmacy-portal-utils";

export function PharmacyPatientDetail({ patient }: { patient: PharmacyPatient }) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardBody className="grid gap-4 text-sm sm:grid-cols-2">
        ...
        <p className="text-xs text-muted-foreground sm:col-span-2">Read-only pharmacy view</p>
      </CardBody>
    </Card>
  );
}
