...
export function ClinicNoteDetailView({ note }: { note: ClinicNote }) {
  return (
    <div className="space-y-4">
      <Card>
        ...
        <CardBody className="space-y-4 text-sm">
          ...
          <p className="text-xs text-muted-foreground">Read-only oversight view</p>
        </CardBody>
      </Card>
      <Button asChild variant="outline">
        <Link href="/clinic/notes">Back to notes</Link>
      </Button>
    </div>
  );
}
