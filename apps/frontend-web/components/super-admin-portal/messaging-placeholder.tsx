...
const PLACEHOLDER_MESSAGES = [
  {
    id: "1",
    sender: "Clinic admin",
    content: "We need help configuring tenant billing settings.",
    time: "Today",
  },
  {
    id: "2",
    sender: "You",
    content: "I will review the tenant configuration shortly.",
    time: "Today",
  },
];

export function PlatformMessagingPlaceholder() {
  return (
    <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
      <Card className="flex min-h-[420px] flex-col">
        <CardHeader>
          <CardTitle>Platform messaging</CardTitle>
          <CardDescription>Placeholder inbox for tenant administrator communication.</CardDescription>
        </CardHeader>
