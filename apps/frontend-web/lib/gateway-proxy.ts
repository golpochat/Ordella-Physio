...
const SERVICE_GATEWAY_MAP: Record<ApiServiceKey, string> = {
  ...
  superAdminOrganization: GATEWAY_PATHS.superAdminOrganization,
  superAdminTenant: GATEWAY_PATHS.superAdminTenant,
  superAdminProvisioning: GATEWAY_PATHS.superAdminProvisioning,
...
const SERVICE_API_PREFIX: Record<ApiServiceKey, string> = {
  ...
  superAdminOrganization: "/api/super-admin/organizations",
  superAdminTenant: "/api/super-admin/tenants",
