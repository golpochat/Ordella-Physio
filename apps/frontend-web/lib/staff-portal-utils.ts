...
export function getTodaysAppointments(appointments: StaffAppointment[]): StaffAppointment[] {
...
export function partitionStaffAppointments(appointments: StaffAppointment[]) {
