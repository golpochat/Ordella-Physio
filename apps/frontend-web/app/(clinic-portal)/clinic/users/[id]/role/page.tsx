...
import { parseUserRoleChangeErrors } from "@/lib/user-api-errors";
import { useAuthStore } from "@/store/auth.store";

export default function ClinicUserRolePage() {
  ...
  useEffect(() => {
    ...
    const result = parseUserRoleChangeErrors(error);
  ...
  return (
    <WithPermission permission="user.manage">
      ...
      {!isLoading && !isError && user ? <UserRoleForm user={user} /> : null}
