...
export default function PrivacyPage() {
  return (
    <Section className="pt-16">
      <SectionHeader title="Privacy Policy" description="Last updated: June 2026" align="left" />
      <div className="max-w-3xl">
        ...
        <p className="mt-2 text-muted-foreground">For privacy-related inquiries, contact privacy@ordella.com.</p>
      </div>
    </Section>
  );
}
